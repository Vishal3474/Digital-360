  ...
  return (
    <div className="lg:flex text-gray-500 mb-10 ">
      ...
      <div className="space-y-5 text-center border-2 border-gray-500 ml-10 mr-10 bg-white rounded-md  ">
        ...
        <h1 className="text-xl mb-10 mt-7 lg:ml-24 lg:mr-24">Perfact For Freelancer</h1>
      ...
      <div className="space-y-5 text-center border-2 border-gray-500 lg:ml-10 lg:mr-10 rounded-md bg-white">
